...
lingkaranMerah(-7.022280, 113.359247).add_to(m)
lingkaranMerah(-7.016993, 113.336931).add_to(m)
lingkaranMerah(-7.053787, 113.004595).add_to(m)
lingkaranMerah(-7.134867, 112.963396).add_to(m)
lingkaranBiru(-7.102263, 112.751928).add_to(m)
lingkaranBiru(-7.070658, 112.770296).add_to(m)
lingkaranBiru(-7.029254, 112.821794).add_to(m)
